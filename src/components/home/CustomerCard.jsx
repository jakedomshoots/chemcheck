    ...
    <Card className={`overflow-hidden transition-all duration-200 border-2 ${isCompleted
      ...
      >
        <div className="flex items-center gap-2 flex-1 min-w-0">
          <div className={`w-9 h-9 rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0 ${isCompleted ? 'bg-gradient-to-br from-emerald-500 to-teal-600' : 'bg-gradient-to-br from-cyan-500 to-blue-600'
            }`}>
