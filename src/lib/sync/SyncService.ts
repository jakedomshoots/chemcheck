          ...
          case 'serviceLogs':
            ...
            result = await this.convexClient.mutation(api.sync.syncServiceLog, {
              ...
              data: {
                ...
                total_chlorine_value: record.total_chlorine_value,
                total_bromine_value: record.total_bromine_value,
                strip_scan_method: record.strip_scan_method,
                strip_scan_confidence: record.strip_scan_confidence,
                strip_scan_analysis_version: record.strip_scan_analysis_version,
                strip_scan_pad_confidence: record.strip_scan_pad_confidence,
                strip_scan_quality: record.strip_scan_quality,
                lsi_calculation_version: record.lsi_calculation_version,
                alkalinity_value: record.alkalinity_value,
                stabilizer_value: record.stabilizer_value,
                hardness_value: record.hardness_value,
                hardness_source: record.hardness_source,
                water_temperature: record.water_temperature,
                water_temperature_source: record.water_temperature_source,
                tds_value: record.tds_value,
                tds_source: record.tds_source,
