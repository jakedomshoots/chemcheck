      ...
      <section className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-xl items-center justify-center px-4 py-10 sm:px-6">
        <div className="w-full">
          <div className="mb-4 flex justify-center">
            <span
              className="inline-flex items-center gap-2 rounded-full border border-[var(--status-info-line)] bg-surface-1 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-brand-ink shadow-sm"
              role="status"
              aria-live="polite"
            >
          ...
          <div className="rounded-sheet border border-line bg-surface-1 p-6 text-center shadow-card sm:p-8">
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-softer text-brand-ink">
